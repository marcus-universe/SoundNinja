...
<!-- Filter (at-icons:filter) -->
<svg v-if="icon === 'filter'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" :class="[customClass]" @click="$emit('triggered', icon)">
  <path class="cls-1" d="M14 1a1 1 0 0 1 1 1v1.586a1 1 0 0 1-.293.707L10 9v4.219a1 1 0 0 1-.758.97l-2.62.656A.5.5 0 0 1 6 14.359V9L1.293 4.293A1 1 0 0 1 1 3.586V2a1 1 0 0 1 1-1z"/>
</svg>
