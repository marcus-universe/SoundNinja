...
<div class="SettingPanel flex-center ">
    <div class="SettingBox flex-c-w ">
        <img v-on:click="OpenSettings" src="../Assets/IMG/Exit.svg" alt="Exit Settings Button" class="ExitSetting">
        <h2>Settings</h2>
        <ul class="flex_c_h SettingList">
            <li class="flex-c-rand">Color Theme:
                <input v-model="colorpick" v-on:input="changeColor" v-on:change="writeColor" type="color" name="Colorpicker" id="Colorpicker" class="colorpicker">
            </li>
            <li class="flex-c-rand">Show Logo Icon:<input type="checkbox" name="LogoActive" id="" class="checkbox">
            </li>
