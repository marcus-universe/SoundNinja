...
1. Download [SoundNinja-Companion.tgz](https://github.com/marcus-universe/SoundNinja/releases/latest/download/SoundNinja-Companion.tgz) and load it in Companion (**Modules → Load module package**).
