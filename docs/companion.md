...
3. Download the latest [Companion module `.tgz`](https://github.com/marcus-universe/companion-module-soundninja/releases/latest) and load it in Companion (**Modules → Load module package**). Paste the IP + port into the connection.

Source: [companion-module-soundninja](https://github.com/marcus-universe/companion-module-soundninja). Run **Actions → Release** in that repo to create a GitHub Release **draft** and attach `SoundNinja-Companion.tgz` plus `SoundNinja-Companion-{Version}.tgz`.
